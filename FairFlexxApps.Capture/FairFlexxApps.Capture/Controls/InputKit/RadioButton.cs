...
using FairFlexxApps.Capture.Controls.InputKit.Abstraction;
using FairFlexxApps.Capture.Controls.InputKit.Configuration;
using Microsoft.Maui;

namespace FairFlexxApps.Capture.Controls.InputKit
{
    /// <summary>
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public class RadioButton : StackLayout
    {
        ...
        {
            Color = Colors.Black, //Color.Accent,
            BorderColor = Colors.Black,
            TextColor = Colors.Black,//(Color)Label.TextColorProperty.DefaultValue,
            //Size = (Math.Max(App.DisplayScreenWidth, App.DisplayScreenHeight) > 1620) ? 16 + 4 : 16,
            Size = (double)((double)App.Current.Resources["NormalLabelControlFont"] + (int)App.Settings.FontSize), //Device.GetNamedSize(Device.RuntimePlatform == Device.iOS ? NamedSize.Medium : NamedSize.Small, typeof(Label)),
            CornerRadius = -1,
            //FontSize = (Math.Max(App.DisplayScreenWidth, App.DisplayScreenHeight) > 1620) ? 16 + 4 : 16,
            FontSize = (double)((double)App.Current.Resources["NormalLabelControlFont"] + (int)App.Settings.FontSize), //Device.GetNamedSize(Device.RuntimePlatform == Device.iOS ? NamedSize.Medium : NamedSize.Small, typeof(Label)),
        };
        //.92
        //1.66 minReq
        ...
        {
            Margin = Device.RuntimePlatform == Device.Android ? new Thickness(0, 5, 0, 0) : new Thickness(0,0,0,0),
            Text = "",
            VerticalTextAlignment = TextAlignment.Center,
        ...
        public string Text
        {
            ...
            set
            {
                ...
                else if (value == "FairFlexxApps.Capture.Models.Templates.Controls.InputSelectionModel")
                {
                    value = string.Empty;
        ...
        public double TextFontSize
        {
            ...
            set { lblText.FontSize = (double)App.Current.Resources["NormalLabelControlFont"] + (int)App.Settings.FontSize; }
        }
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create(nameof(Text), typeof(string), typeof(RadioButton), string.Empty, propertyChanged: (bo, ov, nv) => (bo as RadioButton).Text = (string)nv == "FairFlexxApps.Capture.Models.Templates.Controls.InputSelectionModel" ? string.Empty : (string)nv);
        ...
        public static readonly BindableProperty ColorProperty = BindableProperty.Create(nameof(Color), typeof(Color), typeof(RadioButton), Colors.Transparent, propertyChanged: (bo, ov, nv) => (bo as RadioButton).Color = (Color)nv);
        public static readonly BindableProperty CircleColorProperty = BindableProperty.Create(nameof(CircleColor), typeof(Color), typeof(RadioButton), Colors.Transparent, propertyChanged: (bo, ov, nv) => (bo as RadioButton).CircleColor = (Color)nv);
        public static readonly BindableProperty TextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(RadioButton), Colors.Transparent, propertyChanged: (bo, ov, nv) => (bo as RadioButton).TextColor = (Color)nv);
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        void Tapped()
        {
            ...
            if (string.IsNullOrWhiteSpace(lblText.Text) && this.ClassId == "empty")
                return;
            IsChecked = !IsChecked;

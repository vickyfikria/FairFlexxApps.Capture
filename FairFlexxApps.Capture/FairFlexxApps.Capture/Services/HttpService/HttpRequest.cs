    ...
    public class HttpRequest : IHttpRequest
    {
        ...
        public bool IsNetworkConnected
        {
            get
            {
                ...
                {
                    return true;   // Active Wi-Fi connection.
                }
                else
                {
                    return false;
...
#endif
                WriteErrorLog(mes: exception.Message, ex: exception);
                return null;
            }
            finally
            {
            ...
            Func<T, Task> processorSuccess, Func<Task> processorError = null) where T : class
        {
            ...
            else
            {
                ...
                {
                    WriteErrorLog(mes: taskCanceledException.Message, ex: taskCanceledException);
#if DEBUG
                    Debug.WriteLine(
            ...
            Func<Task> processorError = null, object callbackObject = null, HttpMessageHandler httpMesssageHandler = null)
        {
            ...
            {
                WriteErrorLog(mes: unAuEx.Message, ex: unAuEx);
                await MessagePopup.Instance.Show(TranslateExtension.Get("InvalidApiCall"));
            }
            catch (Exception exception)
            {
                WriteErrorLog(mes: exception.Message, ex: exception);
        ...
        private async Task<bool> IsTokenExpired(object response)
        {
            ...
            {
                WriteErrorLog(mes: e.Message, ex: e);
#if DEBUG
                Debug.WriteLine(e);
#endif
            }
        ...
        public void WriteErrorLog(string mes = null, Exception ex = null)
        {
            var vm = PageManager.GetCurrentPageBaseViewModel();
            vm.WriteErrorLog(message: mes, ex: ex);
        }
